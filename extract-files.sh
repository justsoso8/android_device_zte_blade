...
DEVICE=n780
SYSTEMDIR=P020121010542808168083/system

mkdir -p ../../../vendor/zte/$DEVICE/proprietary
cp $SYSTEMDIR/bin/qmuxd ../../../vendor/zte/$DEVICE/proprietary/qmuxd
chmod 755 ../../../vendor/zte/$DEVICE/proprietary/qmuxd
cp $SYSTEMDIR/bin/akmd2 ../../../vendor/zte/$DEVICE/proprietary/akmd2
chmod 755 ../../../vendor/zte/$DEVICE/proprietary/akmd2
cp $SYSTEMDIR/bin/hci_qcomm_init ../../../vendor/zte/$DEVICE/proprietary/hci_qcomm_init
chmod 755 ../../../vendor/zte/$DEVICE/proprietary/hci_qcomm_init

cp $SYSTEMDIR/etc/init.qcom.bt.sh ../../../vendor/zte/$DEVICE/proprietary/init.qcom.bt.sh

# EGL
cp $SYSTEMDIR/lib/egl/libEGL_adreno200.so ../../../vendor/zte/$DEVICE/proprietary/libEGL_adreno200.so
cp $SYSTEMDIR/lib/egl/libGLESv2_adreno200.so ../../../vendor/zte/$DEVICE/proprietary/libGLESv2_adreno200.so
cp $SYSTEMDIR/lib/egl/libGLESv1_CM_adreno200.so ../../../vendor/zte/$DEVICE/proprietary/libGLESv1_CM_adreno200.so
cp $SYSTEMDIR/lib/egl/libq3dtools_adreno200.so ../../../vendor/zte/$DEVICE/proprietary/libq3dtools_adreno200.so
cp $SYSTEMDIR/lib/libgsl.so ../../../vendor/zte/$DEVICE/proprietary/libgsl.so
cp $SYSTEMDIR/etc/firmware/yamato_pfp.fw ../../../vendor/zte/$DEVICE/proprietary/yamato_pfp.fw
cp $SYSTEMDIR/etc/firmware/yamato_pm4.fw ../../../vendor/zte/$DEVICE/proprietary/yamato_pm4.fw


#RIL files
cp $SYSTEMDIR/lib/libril-qc-1.so ../../../vendor/zte/$DEVICE/proprietary/libril-qc-1.so
cp $SYSTEMDIR/lib/libril-qcril-hook-oem.so ../../../vendor/zte/$DEVICE/proprietary/libril-qcril-hook-oem.so
cp $SYSTEMDIR/lib/libdiag.so ../../../vendor/zte/$DEVICE/proprietary/libdiag.so
cp $SYSTEMDIR/lib/liboncrpc.so ../../../vendor/zte/$DEVICE/proprietary/liboncrpc.so
cp $SYSTEMDIR/lib/libqmi.so ../../../vendor/zte/$DEVICE/proprietary/libqmi.so
cp $SYSTEMDIR/lib/libdsm.so ../../../vendor/zte/$DEVICE/proprietary/libdsm.so
cp $SYSTEMDIR/lib/libqueue.so ../../../vendor/zte/$DEVICE/proprietary/libqueue.so
cp $SYSTEMDIR/lib/libdll.so ../../../vendor/zte/$DEVICE/proprietary/libdll.so
cp $SYSTEMDIR/lib/libcm.so ../../../vendor/zte/$DEVICE/proprietary/libcm.so
cp $SYSTEMDIR/lib/libmmgsdilib.so ../../../vendor/zte/$DEVICE/proprietary/libmmgsdilib.so
cp $SYSTEMDIR/lib/libgsdi_exp.so ../../../vendor/zte/$DEVICE/proprietary/libgsdi_exp.so
cp $SYSTEMDIR/lib/libgstk_exp.so ../../../vendor/zte/$DEVICE/proprietary/libgstk_exp.so
cp $SYSTEMDIR/lib/libwms.so ../../../vendor/zte/$DEVICE/proprietary/libwms.so
cp $SYSTEMDIR/lib/libnv.so ../../../vendor/zte/$DEVICE/proprietary/libnv.so
cp $SYSTEMDIR/lib/libwmsts.so ../../../vendor/zte/$DEVICE/proprietary/libwmsts.so
cp $SYSTEMDIR/lib/libpbmlib.so ../../../vendor/zte/$DEVICE/proprietary/libpbmlib.so
cp $SYSTEMDIR/lib/libdss.so ../../../vendor/zte/$DEVICE/proprietary/libdss.so
cp $SYSTEMDIR/lib/libauth.so ../../../vendor/zte/$DEVICE/proprietary/libauth.so

#sensors + lights
cp $SYSTEMDIR/lib/hw/sensors.default.so ../../../vendor/zte/$DEVICE/proprietary/sensors.default.so
cp $SYSTEMDIR/lib/hw/lights.msm7k.so ../../../vendor/zte/$DEVICE/proprietary/lights.msm7k.so

#camera
cp $SYSTEMDIR/lib/liboemcamera.so ../../../vendor/zte/$DEVICE/proprietary/liboemcamera.so
cp $SYSTEMDIR/lib/libmmjpeg.so ../../../vendor/zte/$DEVICE/proprietary/libmmjpeg.so
cp $SYSTEMDIR/lib/libmmipl.so ../../../vendor/zte/$DEVICE/proprietary/libmmipl.so

#OMX
cp $SYSTEMDIR/lib/libOmxEvrcEnc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxEvrcEnc.so
cp $SYSTEMDIR/lib/libOmxAacDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAacDec.so
cp $SYSTEMDIR/lib/libOmxWmvDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxWmvDec.so
cp $SYSTEMDIR/lib/libOmxQcelpDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxQcelpDec.so
cp $SYSTEMDIR/lib/libOmxAmrEnc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrEnc.so
cp $SYSTEMDIR/lib/libOmxAdpcmDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAdpcmDec.so
cp $SYSTEMDIR/lib/libOmxEvrcDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxEvrcDec.so
cp $SYSTEMDIR/lib/libOmxH264Dec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxH264Dec.so
cp $SYSTEMDIR/lib/libOmxAmrDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrDec.so
cp $SYSTEMDIR/lib/libOmxAmrwbDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrwbDec.so
cp $SYSTEMDIR/lib/libOmxWmaDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxWmaDec.so
cp $SYSTEMDIR/lib/libOmxQcelp13Enc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxQcelp13Enc.so
cp $SYSTEMDIR/lib/libOmxMp3Dec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxMp3Dec.so
cp $SYSTEMDIR/lib/libOmxMpeg4Dec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxMpeg4Dec.so
cp $SYSTEMDIR/lib/libOmxVidEnc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxVidEnc.so
cp $SYSTEMDIR/lib/libOmxAmrRtpDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrRtpDec.so
cp $SYSTEMDIR/lib/libOmxAacEnc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAacEnc.so
cp $SYSTEMDIR/lib/libmm-adspsvc.so ../../../vendor/zte/$DEVICE/proprietary/libmm-adspsvc.so
cp $SYSTEMDIR/lib/libomx_aacdec_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_aacdec_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_amrdec_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_amrdec_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_amrenc_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_amrenc_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_avcdec_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_avcdec_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_m4vdec_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_m4vdec_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_mp3dec_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_mp3dec_sharedlibrary.so
cp $SYSTEMDIR/lib/libomx_sharedlibrary.so ../../../vendor/zte/$DEVICE/proprietary/libomx_sharedlibrary.so
